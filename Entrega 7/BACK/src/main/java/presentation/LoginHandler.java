...
public class LoginHandler implements Handler {
    ...
    public void handle(@NotNull Context context) throws Exception {
        ...
        try {
            results = em.createQuery("SELECT t FROM Usuario t where t.correo = ?1 and t.contrasenia = ?2", Usuario.class) //!!!!!
        ...
        // Conviene que la fecha de inicio este en el idSession?? Porque depues la vamos a tener que usar
